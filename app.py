...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/amresh8810/Smart-AI-Resume-Analyzer/new/main' target='_blank' style='text-decoration: none;'>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [job search AIAgent](https://github.com/amresh8810/Daly_job_search_AIAgent-)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [order chat bot](https://github.com/amresh8810/-Order_chat_bot)", icon="ℹ️")
    ...
    "assets",
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <div class="social-links">
                    ...
                    <a href="mailto:amreshkumar08797@gmail.com" class="social-link" target="_blank">
        ...
        st.toast("Check out these repositories: [AI lead qualification](https://github.com/amresh8810/AI-Lead-Qualification-and-Follow-up)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [AI lead](https://github.com/amresh8810/AI-Lead-Qualification-and-Follow-up)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [job search AIAgent](https://github.com/amresh8810/jobSerarchBOTTelegram)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [Varinda store sales](https://github.com/amresh8810/varinda-store-sales)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/amresh8810/varinda-store-sales" target="_blank" style="color: #4CAF50;">Varinda Store Sales</a></li>
        <li><a href="https://github.com/amresh8810/Awesome-Hacking" target="_blank" style="color: #4CAF50;">Awesome Hacking</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://www.linkedin.com/in/amresh-kumar-8451162a6/recent-activity/all/" target="_blank" style="color: #4CAF50;">Awesome Java</a></li>
        <li><a href="https://github.com/amresh8810/30-Days-Of-Rust" target="_blank" style="color: #4CAF50;">30 Days Of Rust</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/amresh8810/GeeksforGeeks-POTD" target="_blank" style="color: #4CAF50;">GeeksforGeeks POTD</a></li>
        <li><a href="https://github.com/amresh8810/Leetcode-POTD" target="_blank" style="color: #4CAF50;">Leetcode POTD</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>AI/ML Projects:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://www.linkedin.com/in/amresh-kumar-8451162a6/recent-activity/all/" target="_blank" style="color: #4CAF50;">Amresh</a></li>
    </ul>
